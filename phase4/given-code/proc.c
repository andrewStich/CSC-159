...
//   outportb(term[term_no].io_base+IER, IER_ETXRDY); // enable only TX intr (optional)
   for(i=0; i<LOOP/2; i++)asm("inb $0x80");
...
/* // for VM where Procomm which a key is pressed 1st, a RXRDY will occur unless this:
